...
<body class="flex flex-col h-screen">
                ...
                <div class="grid grid-cols-3 gap-4">
                    ...
                    <div class="pb-4">
                        <div
                            ...
                            <p class="text-white text-sm">Kadar Karbon Metana (CH4)</p>
                            <p class="text-white text-sm">Saat ini</p>
    ...
    <script>
        function fetchData() {
            $.ajax({
                        url: 'http://127.0.0.1:8000/dashboard/detail/1',
                        type: 'GET',
                        success: function(data) {
                                ...
                                h6 class = "m-0 font-semibold text-gray-700" > Dashboard < /h6> <
                                    ...
                                    div
                                class =
                                "bg-dgreen h-full px-8 rounded-lg shadow-lg flex flex-col justify-center items-center" >
                                <
                                div class = "flex justify-between w-full mb-6 items-center" >
                                <
                                p class = "text-white text-sm font-bold" > Temperature(CH4) < /p> <
                                ...
                                id = "percentageValueTemperature" > < /p> <
                                    /div> <
                                    /div>
                                    ...
                                    div class = "progress-container" >
                                    <
                                    div id = "progressFillTemperature"
                                class = "progress-bar-fill" > < /div> <
                                div id = "progressNeedleTemperature"
                                class = "progress-needle" > < /div> <
                                /div>
                                ...
                                class = "text-white text-5xl font-bold mb-4" > < /div> <
                                p id = "lastUpdatedTemperature"
                                ...
                                p class = "text-white text-sm font-bold" > Humidity(CH4) < /p> <
                                    div class = "flex items-center" >
                                    <
                                    div id = "colorIndicatorHumidity"
                                class = "w-3 h-3 rounded-full mr-2" > < /div> <
                                p class = "text-white text-sm"
                                id = "percentageValueHumidity" > < /p> <
                                    /div> <
                                    /div>
                                    ...
                                    div class = "progress-container" >
                                    <
                                    div id = "progressFillHumidity"
                                class = "progress-bar-fill" > < /div> <
                                div id = "progressNeedleHumidity"
                                class = "progress-needle" > < /div> <
                                /div>
                                ...
                                p class = "text-white text-sm" > Buruk < /p> <
                                    ...
                                    p class = "text-white text-sm" > Humidity(CH4) < /p> <
                                    p class = "text-white text-sm" > Saat ini < /p> <
                                    div id = "latestValueHumidity"
                                class = "text-white text-5xl font-bold mb-4" > < /div> <
                                p id = "lastUpdatedHumidity"
                                class = "text-white text-sm" > < /p> <
                                /div> <
                                /div> <
                                /div> <
                                ...
                                p class = "text-white text-sm" > Buruk < /p> <
                                    ...
                                    p class = "text-white text-sm" > Kadar Karbon Dioksida(CO2) < /p> <
                                    p class = "text-white text-sm" > Saat ini < /p> <
                                    div id = "latestValueDioksida"
                                class = "text-white text-5xl font-bold mb-4" > < /div> <
                                p id = "lastUpdatedDioksida"
                                class = "text-white text-sm" > < /p> <
                                /div> <
                                /div> <
                                /div>
                                ...
                                p class = "text-white text-sm font-bold" > Karbon Metana(CH4) < /p> <
                                    div class = "flex items-center" >
                                    <
                                    div id = "colorIndicatorMetana"
                                class = "w-3 h-3 rounded-full mr-2" > < /div> <
                                p class = "text-white text-sm"
                                id = "percentageValueMetana" > < /p> <
                                    /div> <
                                    /div>
                                    ...
                                    div class = "progress-container" >
                                    <
                                    div id = "progressFillMetana"
                                class = "progress-bar-fill" > < /div> <
                                div id = "progressNeedleMetana"
                                class = "progress-needle" > < /div> <
                                /div>
                                ...
                                p class = "text-white text-sm" > Buruk < /p> <
                                    ...
                                    p class = "text-white text-sm" > Saat ini < /p> <
                                    div id = "latestValueMetana"
                                class = "text-white text-5xl font-bold mb-4" > < /div> <
                                p id = "lastUpdatedMetana"
                                class = "text-white text-sm" > < /p> <
                                /div> <
                                /div>
                                ...
                                p class = "text-white text-sm font-bold" > Amonia < /p> <
                                    div class = "flex items-center" >
                                    <
                                    div id = "colorIndicatorAmonia"
                                class = "w-3 h-3 rounded-full mr-2" > < /div> <
                                p class = "text-white text-sm"
                                id = "percentageValueAmonia" > < /p> <
                                    /div> <
                                    /div>
                                    ...
                                    div class = "progress-container" >
                                    <
                                    div id = "progressFillAmonia"
                                class = "progress-bar-fill" > < /div> <
                                div id = "progressNeedleAmonia"
                                class = "progress-needle" > < /div> <
                                /div>
                                ...
                                p class = "text-white text-sm" > Buruk < /p> <
                                    ...
                                    p class = "text-white text-sm" > Saat ini < /p> <
                                    div id = "latestValueAmonia"
                                class = "text-white text-5xl font-bold mb-4" > < /div> <
                                p id = "lastUpdatedAmonia"
                                class = "text-white text-sm" > < /p> <
                                /div> <
                                /div> <
                                /div> <
    ...
    <script>
        ...
        var updateChartTemperature = function() {
            $.ajax({
                ...
                success: function(data) {
                    // Update chart
                    chartTemperature.data.labels = data.temperature.labels;
                    chartTemperature.data.datasets[0].data = data.temperature.data;
                    chartTemperature.update();

                    // Update the latest value and last updated time
                    var latestValue = data.temperature.latest.nilai_temperature;
                    var lastUpdated = new Date(data.temperature.latest.updated_at).toLocaleString();
                    $('#latestValueTemperature').text(latestValue);
                    $('#lastUpdatedTemperature').text('Terakhir update ' + lastUpdated);

                    // Calculate percentage for the progress bar and needle position
                    var minValue = 20; // Change to the minimum value of methane level
                    var maxValue = 100; // Change to the maximum value of methane level
                    var percentage = ((latestValue - minValue) / (maxValue - minValue)) * 100;
...
</html>latestValueTemperature = data.latest.nilai_temperature;
var lastUpdatedTemperature = new Date(data.latest.updated_at).toLocaleString();
$('#latestValueTemperature').text(latestValueTemperature);
$('#lastUpdatedTemperature').text('Terakhir update ' + lastUpdatedTemperature);

// Calculate percentage for the progress bar and needle position
var minValueTemperature = 10; // Ganti dengan nilai minimum kadar temperature
var maxValueTemperature = 40; // Ganti dengan nilai maksimum kadar temperature
var percentageTemperature = ((latestValueTemperature - minValueTemperature) / (maxValueTemperature -
minValueTemperature)) * 100;

// Update the progress bar and needle position
var progressFillTemperature = $('#progressFillTemperature');
var progressNeedleTemperature = $('#progressNeedleTemperature');
progressFillTemperature.css('width', percentageTemperature + '%');
progressNeedleTemperature.css('left', percentageTemperature + '%');
$('#percentageValueTemperature').text(percentageTemperature.toFixed(2) + '%');

// Update the color of the small circle based on percentage
var colorIndicatorTemperature = $('#colorIndicatorTemperature');
if (percentageTemperature <= 33) { colorIndicatorTemperature.css('background-color', 'red' ); } else if
    (percentageTemperature <=66) { colorIndicatorTemperature.css('background-color', 'yellow' ); } else {
    colorIndicatorTemperature.css('background-color', 'green' ); } // Repeat similar code for Humidity and other
    parameters var latestValueHumidity=data.latest.nilai_humidity; var lastUpdatedHumidity=new
    Date(data.latest.updated_at).toLocaleString(); $('#latestValueHumidity').text(latestValueHumidity);
    $('#lastUpdatedHumidity').text('Terakhir update ' + lastUpdatedHumidity);

                    var minValueHumidity = 30; // Ganti dengan nilai minimum kadar humidity
                    var maxValueHumidity = 90; // Ganti dengan nilai maksimum kadar humidity
                    var percentageHumidity = ((latestValueHumidity - minValueHumidity) / (maxValueHumidity - minValueHumidity)) * 100;

                    var progressFillHumidity = $(' #progressFillHumidity'); var
    progressNeedleHumidity=$('#progressNeedleHumidity'); progressFillHumidity.css('width', percentageHumidity + '%' );
    progressNeedleHumidity.css('left', percentageHumidity + '%' );
    $('#percentageValueHumidity').text(percentageHumidity.toFixed(2) + '%' ); var
    colorIndicatorHumidity=$('#colorIndicatorHumidity'); if (percentageHumidity <=33) {
    colorIndicatorHumidity.css('background-color', 'red' ); } else if (percentageHumidity <=66) {
    colorIndicatorHumidity.css('background-color', 'yellow' ); } else {
    colorIndicatorHumidity.css('background-color', 'green' ); } // Repeat for CO2 and CH4 var
    latestValueDioksida=data.latest.nilai_dioksida; var lastUpdatedDioksida=new
    Date(data.latest.updated_at).toLocaleString(); $('#latestValueDioksida').text(latestValueDioksida);
    $('#lastUpdatedDioksida').text('Terakhir update ' + lastUpdatedDioksida);

                    var minValueDioksida = 200; // Ganti dengan nilai minimum kadar dioksida
                    var maxValueDioksida = 1000; // Ganti dengan nilai maksimum kadar dioksida
                    var percentageDioksida = ((latestValueDioksida - minValueDioksida) / (maxValueDioksida - minValueDioksida)) * 100;

                    var progressFillDioksida = $(' #progressFill'); var progressNeedleDioksida=$('#progressNeedle');
    progressFillDioksida.css('width', percentageDioksida + '%' ); progressNeedleDioksida.css('left', percentageDioksida
    + '%' ); $('#percentageValue').text(percentageDioksida.toFixed(2) + '%' ); var
    colorIndicatorDioksida=$('#colorIndicator'); if (percentageDioksida <=33) {
    colorIndicatorDioksida.css('background-color', 'red' ); } else if (percentageDioksida <=66) {
    colorIndicatorDioksida.css('background-color', 'yellow' ); } else {
    colorIndicatorDioksida.css('background-color', 'green' ); } var latestValueMetana=data.latest.nilai_metana; var
    lastUpdatedMetana=new Date(data.latest.updated_at).toLocaleString();
    $('#latestValueMetana').text(latestValueMetana); $('#lastUpdatedMetana').text('Terakhir update ' + lastUpdatedMetana);

                    var minValueMetana = 1.8; // Ganti dengan nilai minimum kadar metana
                    var maxValueMetana = 5; // Ganti dengan nilai maksimum kadar metana
                    var percentageMetana = ((latestValueMetana - minValueMetana) / (maxValueMetana - minValueMetana)) * 100;

                    var progressFillMetana = $(' #progressFillMetana'); var
    progressNeedleMetana=$('#progressNeedleMetana'); progressFillMetana.css('width', percentageMetana + '%' );
    progressNeedleMetana.css('left', percentageMetana + '%' );
    $('#percentageValueMetana').text(percentageMetana.toFixed(2) + '%' ); var
    colorIndicatorMetana=$('#colorIndicatorMetana'); if (percentageMetana <=33) {
    colorIndicatorMetana.css('background-color', 'red' ); } else if (percentageMetana <=66) {
    colorIndicatorMetana.css('background-color', 'yellow' ); } else {
    colorIndicatorMetana.css('background-color', 'green' ); } }, error: function (data) { console.log(data); } }); }
    $(document).ready(function () { fetchData(); // Initial fetch // Set an interval to fetch data periodically
    setInterval(fetchData, 10000); // Fetch data every 10 seconds }); </script>
    </body>
