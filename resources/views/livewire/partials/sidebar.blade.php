<aside class="text-white w-52 flex-shrink-0 hidden lg:block "
    ...
    <nav class="px-2 py-2">
        ...
        <a id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
            class="flex items-center block py-2 text-white text-body hover:text-green-600 hover:bg-gray-100 rounded-lg px-3 mb-3 transition duration-200"
            type="button"> <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 20 20"
                fill="currentColor">
                <path
            ...
            Rekam Data<svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                viewBox="0 0 10 6">
            ...
            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                <li>
                    <a href="{{ route('riwayat') }}"
                        class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Riwayat Temperature</a>
                </li>
                <li>
                    <a href="#"
