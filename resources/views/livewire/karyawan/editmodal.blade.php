...
<div id="modaledit{{$item->id}}" tabindex="-1" aria-hidden="true"
            ...
            <form wire:submit.prevent="save">
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="modaledit{{$item->id}}">
                ...
                <div
                    ...
                    <button type="submit" data-modal-hide="modaledit{{$item->id}}"
                        ...
                        accept</button>
                    <button data-modal-hide="modaledit{{$item->id}}" type="button"
