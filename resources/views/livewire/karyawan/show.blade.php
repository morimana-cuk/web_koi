<div class="">
   ...
   <table class="min-w-full bg-white border-collapse border border-gray-200">
    <thead class="bg-dgreen">
        <tr>
            <th class="bg-dgreen text-white font-semibold px-4 py-2">No</th>
            <th class="bg-dgreen text-white font-semibold px-4 py-2">Nama</th>
            <th class="bg-dgreen text-white font-semibold px-4 py-2">Email</th>
            <th class="bg-dgreen text-white font-semibold px-4 py-2">No Hp</th>
            <th class="bg-dgreen text-white font-semibold px-4 py-2">Alamat</th>
            <th class="bg-dgreen text-white font-semibold px-4 py-2">Level</th>
            <th class="bg-dgreen text-white font-semibold px-4 py-2">Aksi</th>
        </tr>
    </thead>
    <tbody>
        @foreach ($users as $item)
            <tr class="">
                ...
                <td class="border-b border-gray-300 px-4 py-2">{{ $item->email }}</td>
                <td class="border-b border-gray-300 px-4 py-2"> <div class="flex justify-center">{{ $item->address }}</div>
                </td>
                <td class="border-b border-gray-300 px-4 py-2">{{ $item->phone }}</td>
                <td class="border-b border-gray-300 px-4 py-2">{{ $item->role }}</td>
                <td class="border-b border-gray-300 px-4 py-2">
                    <div class="flex justify-center">
                        <!-- Edit Button -->
                        <div class="group">
                           <button wire:click="edit({{ $item->id }})" data-modal-target="edit{{ $item->id }}"
